...
local menu           = game:GetObjects("rbxassetid://17387753511")[1]
...
function library:createConfig()
    ...
    writefile("Euphoria/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("Euphoria/"..name..".cfg") then
        return
    end
  
    local config = game:GetService("HttpService"):JSONDecode(readfile("Euphoria/"..name..".cfg"))
...
function library:refreshConfigs()
    ...
    for i,v in next, listfiles("Euphoria") do
        table.insert(tbl,v)
    end
...
function library:deleteConfig()
    if isfile("Euphoria/"..library.flags["selected_config"]..".cfg") then
        delfile("Euphoria/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
